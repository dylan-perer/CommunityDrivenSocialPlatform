...
namespace CommunityDrivenSocialPlatform_APi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer(Configuration.GetConnectionString("CommunityDrivenSocialPlatfromDb")));// adding database service
